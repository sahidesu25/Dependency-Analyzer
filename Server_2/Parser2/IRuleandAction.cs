...
namespace CodeAnalysis
{
    ...
    {
        void doAction(CSsemi.CSemiExp semi, string file);
    }
    /////////////////////////////////////////////////////////
    ...
    public abstract class AAction : IAction
    {
        ...
        public abstract void doAction(CSsemi.CSemiExp semi, string file);
    ...
    {
        bool test(CSsemi.CSemiExp semi, string file);
    ...
    public abstract class ARule : IRule
    {
        ...
        abstract public bool test(CSsemi.CSemiExp semi, string file);
        public void doActions(CSsemi.CSemiExp semi, string file)
        {
