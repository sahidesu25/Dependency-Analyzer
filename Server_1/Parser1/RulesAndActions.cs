    ...
    public class PushStackRelationship : AAction
    {
        ...
        public void doActionInheritance(CSsemi.CSemiExp semi, string file, ElemRelation elem)
        {
            ...
            if (semi[0].Equals("Inheritance"))
            {
                ...
                //for (int i = repo_.locations.Count-1; i > 0; i--)
                //{
                //    if(repo_.locations[i].namespaces!=null)
                //    {
                //        elem.fromClassNamespace = repo_.locations[i].namespaces;
                //    }
                //}
                ...
                {
                    if (elem.fromClass == e.name)
                    {
                        elem.fromClassFilename = e.fileName;
                        elem.fromClassNamespace = e.namespaces;
                        break;
                ...
                foreach (Elem e in outputList)
                {
                    if (elem.toClass == e.name)
                    {
                        elem.toClassFilename = e.fileName;
                        elem.toClassNamespace = e.namespaces;
                        break;
                    }
                }
