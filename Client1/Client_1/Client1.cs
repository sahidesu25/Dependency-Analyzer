///////////////////////////////////////////////////////////////////////
// Client1.cs   - This package acts as a client and requests the     //
//                 server                                            //
//                                                                   //
// ver 1.0                                                           //
    ...
    public class MessageClient
    {
      ...
      static int z = 1;
       ...
       public static int check_point = 0;
        ...
        {
            ServiceHost host = CreateServiceChannel("http://localhost:7000/MessageService");
            ...
            IMessageService proxy = CreateClientChannel("http://localhost:" + remoteAddr + "/MessageService");
              ...
              message.src = new Uri("http://localhost:7000/MessageService");
     ...
     public void GetAnalysis(ServiceMessage message)  //retrieving xml document from messagebody, 
         //which comes from service contract, and queries it.
        {
          lock (locker_)
            {
              z = z + 1;
     ...
     static void Main(string[] args)
     {
         ...
         {
             Console.WriteLine("the Caught Exception is", e);
         ...
         {
             Console.WriteLine("the caught Exception is");
